    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 gap-6">
        {bookingList.map((booking: any) => {
          const firstImage = (Array.isArray(booking.tour.images) ? booking.tour.images[0] : booking.tour.images?.split(',')[0]) || '';
          return (
              ...
              <div className="flex-grow p-8 flex flex-col justify-between">
                <div className="flex justify-between items-start mb-6">
                  <div>
                    ...
                    <h3 className="text-2xl font-black text-slate-900">{getTranslation(booking.tour.title)}</h3>
                  </div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                  ...
                  <div className="space-y-1">
                    ...
                    <div className="font-bold text-slate-700 text-sm">{new Date(booking.created_at).toLocaleDateString()}</div>
                  </div>
