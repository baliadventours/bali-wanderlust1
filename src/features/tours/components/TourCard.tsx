...
export const TourCard: React.FC<TourCardProps> = ({ tour }) => {
  const firstImage = tour.images.split(',')[0] || 'https://images.unsplash.com/photo-1469474968028-56623f02e42e?auto=format&fit=crop&q=80&w=800';
    ...
    <div className="group bg-white rounded-2xl overflow-hidden border border-slate-100 shadow-sm hover:shadow-xl transition-all duration-500 flex flex-col h-full">
      ...
      <div className="p-6 flex-grow flex flex-col">
        <div className="flex items-center gap-1 text-amber-500 mb-3">
          ...
          <span className="text-slate-400 text-xs font-bold">({tour.ratingsQuantity})</span>
        </div>
        ...
        <div className="grid grid-cols-2 gap-y-4 gap-x-2 mb-8">
          ...
          <div className="flex items-center gap-2 text-slate-400">
            ...
            <span className="text-xs font-bold">Up to {tour.maxGroupSize}</span>
          </div>
        </div>
