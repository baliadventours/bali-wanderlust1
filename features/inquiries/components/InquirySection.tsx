  ...
  if (submitted) {
    return (
      <div className="bg-emerald-50 border border-emerald-100 p-8 rounded-3xl text-center animate-in fade-in zoom-in duration-300">
        ...
        <p className="text-emerald-700 text-sm">Our team will get back to you within 24 hours.</p>
    ...
    <div className="bg-slate-50 border border-slate-100 p-8 rounded-3xl">
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          ...
          <p className="text-slate-500 text-sm font-medium">Ask our experts about this expedition.</p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <textarea 
          ...
          className="w-full p-4 bg-white border border-slate-200 rounded-2xl outline-none focus:ring-2 focus:ring-indigo-500/10 min-h-[120px] text-sm"
          value={message}
